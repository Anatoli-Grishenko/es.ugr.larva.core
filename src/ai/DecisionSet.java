...
public class DecisionSet extends ArrayList<Choice> {
    ...
    public Choice BestChoice() {
        if (this.get(0).getUtility() == Choice.MAX_UTILITY || this.get(0).getUtility() == Choice.MIN_UTILITY) {
            return null;
        } else {
            return this.get(0);
        }
...
//        return getChoice(findChoice(c));
    ...
    public String toString() {
        String res = "";
        for (Choice a : this) {
            if (a.getUtility() == Choice.MAX_UTILITY || a.getUtility() == Choice.MIN_UTILITY) {
                res += "Choice " + a.getName() + " U: ∞ \n";
            } else {
                res += "Choice " + a.getName() + " U: " + String.format("%6.2f", a.getUtility()) + "\n";
            }
        }
        return res;
    }
