...
//        osPane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
//        osPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_NEVER);
//        osPane.validate();
//        this.parentPane.add(osPane);
//
////        orCompass1 = new OleRotatory(odPane, "Compass");
...
////        orCompass1.setBounds(0, 20, 110,110);
////        orCompass1.setForeground(myDash.cLabels);
////        orCompass1.setBackground(myDash.cGauge);
...
//        super.validate();
//
//        osPane.setBounds(this.getBounds());
//        osPane.setBounds(this.getBounds());
//        osPane.setPreferredSize(this.getPreferredSize());
//        odPane.setBounds(osPane.getBounds().x + 100, osPane.getBounds().y, osPane.getWidth() - 100, osPane.getHeight());
//
//        screenPort = new Rectangle(SwingTools.RectangleToDimension(this.getBounds()));
////        screenPort.x=this.getBounds().x+100;
//        viewPort = SwingTools.doNarrow(screenPort, vpStrecht);
//        viewPort.x = screenPort.x + 105;
...
////        orCompass1.setCurrentValue(this.getDecoder().getCompass());
//        if (showFrame) {
...
//        if (myDash == null || myDash.getMyDecoder() == null || !myDash.availableDashBoard) {
//            return this;
//        }
...
//        Point3D p0, p1, p2, p3;
//
//        if (myDash == null || myDash.getMyDecoder() == null) {
//            return this;
//        }
//
//        g.setClip(viewPort);
...
//    }
//
//    public void hudPressed(MouseEvent e) {
...
//            @Override
//            public void OleDraw(Graphics2D g) {
//                paintPalette(g, palette, osPane.getRealX(e.getX()), osPane.getRealY(e.getY()));
//            }
//        });
//        of.pack();
//        of.setSize(50, 600);
...
//    }
//
//    public void hudReleased(MouseEvent e) {
//        of.dispose();
//    }
//
//}
