...
//        return filterStatus(activateCurrentMission(myMission));
//    }
//
...
//                nextWhichwall = whichWall = "NONE";
//                nextdistance = distance = Choice.MAX_UTILITY;
//                return filterStatus(setCurrentGoal());
//            }
//        }
//        Choice a = Ag(E, A);
...
//        defCurrentMission(missionName);
//        return missionName;
//    }
//
//    protected void defCurrentMission(String mission) {
//        Missions.clear();
//        Missions.addMission(mission);
//        Missions.addGoal(mission, mission);
//    }
//
